...
To use copy the HTML and insert it into the HTML section of the custom character sheet text box.
Then switch to the CSS Styling tab, copy and paste the CSS and click the Save Changes button.
